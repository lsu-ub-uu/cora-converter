...
public class ConverterException extends RuntimeException {
	...
	/**
	 * Constructor that creates a new ConverterException using a single message.
	 * 
	 * @param message
	...
	/**
	 * Constructor that creates a new ConverterException using a single message and a previous
	 * excpetion.
	 * 
	 * @param message
	 *            String with the exception message in clear text.
